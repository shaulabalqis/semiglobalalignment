 ...
 * @author ShaulaBalqis
 */
public class proteinList extends javax.swing.JFrame {

    /**
     * Creates new form proteinList
     */
    public proteinList() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(proteinList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new proteinList().setVisible(true);
            }
        });
    }
